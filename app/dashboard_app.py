...
I18N_MESSAGES: Dict[str, Dict[str, str]] = {
    "en": {
        ...
        "app.caption": "Tabs: Project Overview / Restaurant Search / Historical Insights / Predictive Modeling",
        ...
        "predict.header": "Predict",
    },
    "zh-CN": {
        "app.title": "金县餐厅食品安全仪表盘",
        "app.caption": "标签页：项目总览 / 餐厅搜索 / 历史洞察 / 预测建模",
        "locale.label": "语言",
        "tab.overview": "项目总览",
        "tab.search": "餐厅搜索",
        "tab.summary": "历史洞察",
    ...
    "es": {
        ...
        "app.caption": "Pestañas: Resumen del Proyecto / Búsqueda de Restaurantes / Información Histórica / Modelado Predictivo",
        "locale.label": "Idioma",
        ...
        "predict.header": "Predicción",
    },
    "fr": {
        "app.title": "Tableau de Bord de Sécurité Alimentaire du Comté de King",
        "app.caption": "Onglets : Aperçu du Projet / Recherche de Restaurants / Analyses Historiques / Modélisation Prédictive",
        "locale.label": "Langue",
        ...
        "predict.header": "Prédiction",
    },
    "ja": {
        "app.title": "キング郡レストラン食品安全ダッシュボード",
        "app.caption": "タブ：プロジェクト概要 / レストラン検索 / 履歴インサイト / 予測モデリング",
        "locale.label": "言語",
