  ...
  <script>
    ...
    const I18N_MESSAGES = {
      en: {
        ...
        'tab.assignment': 'Assignment Workflow',
      ...
      es: {
        ...
        'tab.assignment': 'Flujo Analítico de la Tarea',
      ...
      fr: {
        ...
        'tab.assignment': 'Workflow Analytique du Devoir',
